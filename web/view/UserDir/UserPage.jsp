                ...
                <c:when test="${empty sessionScope.role}">
                    ...
                    <div class="col-lg-8">
                        <form class="form-inline" method="post" action="${pageContext.request.contextPath}/signin">
                            ...
                            <input class="form-control" placeholder="<fmt:message key="enter.username"/>" type="text"
                                   name="username"
                                   required="">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <c:if test="${not empty sessionScope.role}">
                    <li>
                        <a href="${pageContext.request.contextPath}/userOrders"><i class="fa"></i><fmt:message
                                key="user.myOrders"/></a>
                    </li>
                </c:if>
            </ul>

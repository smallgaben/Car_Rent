    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/newOrderList"><i class="fa"></i><fmt:message
                            key="manager.newOrders"/></a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/orderList"><i class="fa"></i><fmt:message
                            key="manager.orderList"/></a>
                </li>
            </ul>
        </div>
